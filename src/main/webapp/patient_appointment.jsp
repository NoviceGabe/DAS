...
<%	
	...
	ArrayList<AppointmentModel> appos = appDao.get();
%>
       ...
       <th>Action</th>
            ...
            <tr id="<%= appo.getId() %>" data-doc-id="<%= appo.getDoctor().getId()%>" data-sched-id="<%= appo.getSchedule().getId()%>">
                ...
                <td class="status"><%= appo.getStatus().toString().toUpperCase() %></td>
         		<td >
         			<button type="button" name="download" class="btn btn-primary btn-circle btn-sm download" id="" > <i class="fas fa-download"></i></i></button>
                  	<%
                  	
                  	String status = appo.getStatus().toString().toUpperCase();
                  	String cancel = "<button type='button' name='cancel' class='btn btn-danger btn-circle btn-sm cancel' id='' > <i class='fas fa-times'></i></button> ";
